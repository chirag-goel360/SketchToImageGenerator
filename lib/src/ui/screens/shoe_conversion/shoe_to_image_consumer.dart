...
class ShoeConversionConsumer extends StatefulWidget {
  @override
  _ShoeConversionConsumerState createState() => _ShoeConversionConsumerState();
}

class _ShoeConversionConsumerState extends State<ShoeConversionConsumer> {
            ...
            Column(
              ...
              children: [
                ProjectAppBar(
                    ...
                    title: _translate(Strings.SHOE_TO_IMAGE)),
                Padding(
